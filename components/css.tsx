...
export const JetBrains = ({...props}) => {
    return <Bar0 className="rounded-full border-0 cursor-pointer my-1
                bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 hover:animate-pulse
                transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
                 {...props}/>
}
export const Broker = ({...props}) => {
    return <Bar1 className="rounded-full border-0 cursor-pointer my-1
...
export const Engineer = ({...props}) => {
    return <Bar5 className="rounded-full border-0 cursor-pointer my-1
